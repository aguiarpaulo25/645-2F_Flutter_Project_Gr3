...
class ThemeColors {
  static final lightTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.light(primary: Color(0xFF018786)),
    primaryColor: const Color(0xFF018786),
    primaryIconTheme: const IconThemeData(color: Color(0xFF03DAC5)),
    elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(primary: const Color(0xFF018786))),
  ...
  static final darkTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.dark(primary: Color(0xFF018786)),
    primaryColor: const Color(0xFF018786),
    primaryIconTheme: const IconThemeData(color: Color(0xFF03DAC5)),
    elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
            primary: const Color(0xFF4fb7b6),
